// Course data — Levels 1–8: three modules per level on L1–L7; L8 has 2 (23 modules).
        ...
        basic: {
            ...
            modules: [
                ...
                },
                {
                    ...
                    description: 'Events-in/actions-out and IoLoop vocabulary—before you read crate-specific flow.',
                    objectives: [
        ...
        intermediate: {
            ...
            modules: [
                ...
                },
                {
                    ...
                    duration: '~1.5 hours (outline)',
                    difficulty: 'Level 3',
                    path: 'hyperscale/hyperscale-rs/module-phase-03-execution-waves.html',
                    description: 'Outline: post-commit execution, waves, vote retry and wave timeout.',
                    objectives: [
                        'Contrast single-shard execution with cross-shard phase',
                    ],
                    hyperscaleSpecific: true,
                    contributionModule: false,
                },
                {
                    ...
                    duration: '~2 hours (outline)',
                    difficulty: 'Level 3',
                    path: 'hyperscale/hyperscale-rs/module-phase-04-cross-shard-tx.html',
                    description: 'Outline: gossip to all shards, provisions, five-phase protocol.',
                    objectives: [
                        'Map to cross-shard module and tx-flow steps 6 and 13–14',
                    ],
                    hyperscaleSpecific: true,
                    contributionModule: false,
                },
                {
                    courseLevel: '4',
                    id: 'hs-sim-harness',
                    title: 'E2E simulation harness & test case analysis',
                    duration: '1–1.5 hours',
                    difficulty: 'Level 4',
                    path: 'hyperscale/hyperscale-rs/module-hs-simulation-harness-analysis.html',
                    description: 'SimulationRunner, EventKey ordering, run_until, and canonical test_e2e_single_shard_transaction trace.',
                    objectives: [
                        'Separate sim time from wall clock',
                        'Trace SubmitTransaction through the event queue',
                        'Read SimulationStats as a harness health signal',
                    ],
                    hyperscaleSpecific: true,
                    contributionModule: false,
                },
                ...
                {
                    courseLevel: '4',
                    id: 'hs-prod-e2e-harness',
                    title: 'E2E production test case — harness, user input & observability',
                    duration: '1–1.5 hours',
                    difficulty: 'Level 4',
                    path: 'hyperscale/hyperscale-rs/module-hs-production-e2e-harness.html',
                    description: 'Production harness, RPC / tx_submission_sender ingress, what production E2Es can show.',
                    objectives: [
                        'Map RPC SubmitTransaction vs tx_submission_sender to consensus_rx',
                        'Trace test_production_runner_with_network and run_pinned_loop',
                        'List what production E2E tests can observe without a full tx path',
                    ],
                    hyperscaleSpecific: true,
                    contributionModule: false,
                },
                ...
                },
                {
                    ...
                    description: 'Provision-based coordination and receipts—distinct from Phase 2 single-shard BFT drill.',
                    objectives: [
                ...
                },
                {
                    ...
                    objectives: [
                        ...
                        'Anticipate cryptographic touchpoints next',
                    ],
                    hyperscaleSpecific: true,
                    contributionModule: false,
                },
                {
                    ...
                    description: 'View-change timers vs event-driven proposals—orthogonal to execution and crypto chapters.',
                    objectives: [
