...
const GLOSSARY_ENTRIES = [
  ...
  },
  {
    ...
    subCategory: ['Cryptography & Hashing', 'Blockchain & Ledgers'],
    competingConcepts: 'JMT (fixed-depth sparse MT) vs Patricia Merkle tree (variable-length paths, compact). Both give O(log n) proofs for key-value state; JMT has uniform depth which simplifies proofs and updates.',
  },
  {
