#!/usr/bin/env node
/** Regenerate hyperscale course-data.js — 7 levels, 20 modules (3 per level on L1–L6). */
const fs = require('fs');
...
const head = `// Course data — Levels 1–7 (20 modules): three modules per level on L1–L6; L7 has two specialization modules.
