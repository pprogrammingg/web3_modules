...
const modules = [
    ...
    { courseLevel: 5, id: 'hs-e2e-harness', title: 'E2E harnesses (simulation + production)', duration: '2–2.5 hours', difficulty: 'Level 5', path: 'hyperscale/hyperscale-rs/module-hs-simulation-harness-analysis.html', description: 'SimulationRunner/EventKey plus production pinned shard-loop, RPC ingress, and observability—reading before hands-on labs.', objectives: ['Separate sim time from wall clock and trace test_e2e_single_shard_transaction', 'Map RPC SubmitTransaction vs tx_submission_sender to consensus_rx', 'Contrast SimulationRunner with run_shard_loop production wiring'], hyperscaleSpecific: true, contributionModule: false },
