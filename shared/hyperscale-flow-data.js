...
(function (global) {
    ...
    const FILE_REFS = {
        ...
        'crates/node/src/state.rs': { lineHint: 'NodeStateMachine, self.bft', note: 'Tx flow, BFT, overview' },
        'crates/node/src/protocol/mod.rs': { lineHint: 'SubmitTransaction, event loop, protocol handling', note: 'Overview flow 1' },
        ...
        'crates/mempool/src/state.rs': { lineHint: 'mempool state, on_transaction_gossip_arc', note: 'Overview flow 1' },
        ...
        'crates/production/src/adapter.rs': { lineHint: 'libp2p identity derivation', note: 'Module-08 crypto' },
        'crates/production/src/validator.rs': { lineHint: 'derive_libp2p_keypair', note: 'Module-08 crypto' },
